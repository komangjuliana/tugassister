                        ...
                        <section>
                            ...
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://ecs7.tokopedia.net/blog-tokopedia-com/uploads/2019/05/tari-kecak-1-Wikimedia-Commons.jpg" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
                            ...
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://rimbakita.com/wp-content/uploads/2020/06/penari-kecak.jpg" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
                                    <div class="flex flex-wrap">
                                        <h1 class="flex-auto font-medium text-slate-900">
